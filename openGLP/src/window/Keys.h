...
#define GLP_MOUSE_BUTTON_1         0
#define GLP_MOUSE_BUTTON_2         1
#define GLP_MOUSE_BUTTON_3         2
#define GLP_MOUSE_BUTTON_4         3
#define GLP_MOUSE_BUTTON_5         4
#define GLP_MOUSE_BUTTON_6         5
#define GLP_MOUSE_BUTTON_7         6
#define GLP_MOUSE_BUTTON_8         7
#define GLP_MOUSE_BUTTON_LAST      GLP_MOUSE_BUTTON_8
#define GLP_MOUSE_BUTTON_LEFT      GLP_MOUSE_BUTTON_1
#define GLP_MOUSE_BUTTON_RIGHT     GLP_MOUSE_BUTTON_2
#define GLP_MOUSE_BUTTON_MIDDLE    GLP_MOUSE_BUTTON_3