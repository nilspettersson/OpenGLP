...
void ChunkManager::generateChunks() {
	//std::function<void(int, int)> fn = generateChunk;
	std::function<void(int, int)> fn = std::bind(&ChunkManager::generateChunk, this, std::placeholders::_1, std::placeholders::_2);
	spiral(fn);
